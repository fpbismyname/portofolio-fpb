...
const Pengalaman = () => {
  return (
    <>
      <div className="flex flex-col items-center justify-center ssm:hidden lg:block" id="pengalaman">
      ...
      <div className="flex flex-col items-center justify-center ssm:block lg:hidden" id="pengalaman">
